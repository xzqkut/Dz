...
namespace UCHET
{
    internal class Program
    {
        ...
        static void PrintMenu( AddDossierCommand,  PrintDossiersCommand,  DeleteDossierCommand,  SearchByLastNameCommand,  ExitCommand)
        {
        ...
        {
            IsEmpty("Досье пусто. Удаление невозможно.")
        ...
        static void IsEmpty(string text)
        {
            if (names.Length == 0)
            {
